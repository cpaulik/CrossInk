...
void SettingsActivity::rebuildSettingsLists() {
  ...
  systemSettings.push_back(SettingInfo::Action(StrId::STR_WALLABAG_SERVERS, SettingAction::WallabagBrowser));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::OPDSBrowser:
        ...
        break;
      case SettingAction::WallabagBrowser:
        startActivityForResult(std::make_unique<WallabagServerListActivity>(renderer, mappedInput), resultHandler);
        break;
